...
exports.ModernSettingsPanel = void 0;
...
class ModernSettingsPanel {
    static createOrShow(context) {
        ...
        const panel = vscode.window.createWebviewPanel("accessimindSettings", "⚙️ AccessiMind Settings", column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async handleMessage(message) {
        ...
        switch (message.command) {
            ...
            case "resetToDefaults":
                const confirm = await vscode.window.showWarningMessage("Reset all settings to defaults?", "Yes", "No");
                if (confirm === "Yes") {
...
exports.ModernSettingsPanel = ModernSettingsPanel;
//# sourceMappingURL=modernSettingsPanel.js.map