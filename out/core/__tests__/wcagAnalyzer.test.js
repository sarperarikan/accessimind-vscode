...
const wcagAnalyzer_1 = require("../wcagAnalyzer");
// Mock the AIProviderManager
...
describe("WcagAnalyzer", () => {
    let wcagAnalyzer;
    beforeEach(() => {
        wcagAnalyzer = new wcagAnalyzer_1.WcagAnalyzer();
    });
...
//# sourceMappingURL=wcagAnalyzer.test.js.map