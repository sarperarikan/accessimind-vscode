...
class AITestUtils {
    ...
    async testAIProvider() {
        ...
        try {
            logger_1.logger.info(`AI sağlayıcı testi başlatılıyor: ${currentProvider}`);
            ...
            logger_1.logger.error("AI sağlayıcı testi hatası:", error);
            return {
                success: false,
    ...
    async showTestResult(result) {
        const panel = vscode.window.createWebviewPanel("aiTestResult", "🧪 AI Bağlantı Test Sonucu", vscode.ViewColumn.One, {
            enableScripts: true,
...
exports.AITestUtils = AITestUtils;
//# sourceMappingURL=aiTestUtils.js.map