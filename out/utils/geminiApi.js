...
class GeminiAPI {
    ...
    async chat(message) {
        ...
        // Check cache for chat messages too if appropriate, though usually chat is stateful
        // For simple one-off questions, caching is fine.
        ...
        try {
            ...
            if (response.success) {
                this.cache.set(cacheKey, {
                    ...response,
                    responseTime // Original response time
                });
            }
...
Türkçe detaylı açıklamalarla kapsamlı erişilebilirlik iyileştirmeleri sağla.`;
    ...
    async testConnection() {
        try {
            ...
            // Test bağlantısında cache kullanma
