...
async function generateAccessibleCode(prompt, existingCode = "") {
...
Sadece üretilen kodu döndür, açıklama ekleme.`;
            const response = await geminiApi.improveCode({
                code: existingCode,
                fileType: "html",
                language: "html",
...
async function generateCodeFromTemplate(template, analysis, existingCode) {
