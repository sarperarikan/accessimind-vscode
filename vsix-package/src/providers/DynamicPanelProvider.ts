...
export class DynamicPanelProvider implements vscode.WebviewViewProvider {
    ...
    private async simulateImprovement(): Promise<void> {
        // Simülasyon için bekleme
    ...
    private async checkAndUpdateSettings(): Promise<void> {
