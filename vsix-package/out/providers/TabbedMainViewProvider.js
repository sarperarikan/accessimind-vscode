...
class TabbedMainViewProvider {
    ...
    async exportSettings() {
        try {
            ...
            vscode.window.showInformationMessage('📋 Ayarlar panoya kopyalandı (API anahtarı hariç)', 'Dosyaya Kaydet').then(async (selection) => {
    ...
    async showDiagnostics() {
        ...
        const panel = vscode.window.createWebviewPanel('wcagEnhancer.diagnostics', 'AccessiMind Diagnostics', vscode.ViewColumn.One, { enableScripts: true });
        panel.webview.html = this.getDiagnosticsHTML(diagnostics);
    }
    getDiagnosticsHTML(diagnostics) {
        return `
<!DOCTYPE html>
<html lang="tr">
<head>
...
//# sourceMappingURL=TabbedMainViewProvider.js.map