...
exports.generateAccessibleCode = void 0;
const vscode = __importStar(require("vscode"));
const geminiApi_1 = require("../utils/geminiApi");
function generateAccessibleCode(prompt, existingCode = "") {
    return __awaiter(this, void 0, void 0, function* () {
        // Önce Gemini API bağlantısını kontrol et
...
Sadece üretilen kodu döndür, açıklama ekleme.`;
        ...
        const generatedCode = yield generateCodeFromTemplate(template, analysis, existingCode);
        return generatedCode;
    });
}
exports.generateAccessibleCode = generateAccessibleCode;
...
function selectTemplate(analysis, templates) {
    if (analysis.isForm)
...
function generateCodeFromTemplate(template, analysis, existingCode) {
    return __awaiter(this, void 0, void 0, function* () {
...
function adaptExistingCode(existingCode, template) {
...
function addLabelsToInputs(code) {
...
function addAriaLabelsToButtons(code) {
...
function addWcagEnhancements(code, analysis) {
...
function addKeyboardNavigation(code) {
    ...
    return code.replace(/<button([^>]*?)>/g, "<button$1 tabindex=\"0\" onkeydown=\"handleKeyDown(event)\">");
}
function addContrastStyles(code) {
...
function addAriaAttributes(code) {
    // Form elementleri için aria-required ekle
    code = code.replace(/<input([^>]*?)>/g, (match, attributes) => {
